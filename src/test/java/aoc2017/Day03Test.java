...
class Day03Test {
    ...
    class Part2 {
        ...
        public void testCellGeneration() {
            // first ring
            Day03.Cell cell01 = Day03.Cell.firstCell();
            assertThat(cell01.value, is(1L));

            // second ring
            Day03.Cell cell02 = cell01.next();
            assertThat(cell02.value, is(1L));
            Day03.Cell cell03 = cell02.next();
            assertThat(cell03.value, is(2L));
            Day03.Cell cell04 = cell03.next();
            assertThat(cell04.value, is(4L));
            Day03.Cell cell05 = cell04.next();
            assertThat(cell05.value, is(5L));
            Day03.Cell cell06 = cell05.next();
            assertThat(cell06.value, is(10L));
            Day03.Cell cell07 = cell06.next();
            assertThat(cell07.value, is(11L));
            Day03.Cell cell08 = cell07.next();
            assertThat(cell08.value, is(23L));
            Day03.Cell cell09 = cell08.next();
            assertThat(cell09.value, is(25L));

            // third ring
            Day03.Cell cell10 = cell09.next();
            assertThat(cell10.value, is(26L));
            Day03.Cell cell11 = cell10.next();
            assertThat(cell11.value, is(54L));
            Day03.Cell cell12 = cell11.next();
            assertThat(cell12.value, is(57L));
            Day03.Cell cell13 = cell12.next();
            assertThat(cell13.value, is(59L));
            Day03.Cell cell14 = cell13.next();
            assertThat(cell14.value, is(122L));
            Day03.Cell cell15 = cell14.next();
            assertThat(cell15.value, is(133L));
            Day03.Cell cell16 = cell15.next();
            assertThat(cell16.value, is(142L));
            Day03.Cell cell17 = cell16.next();
            assertThat(cell17.value, is(147L));
            Day03.Cell cell18 = cell17.next();
            assertThat(cell18.value, is(304L));
            Day03.Cell cell19 = cell18.next();
            assertThat(cell19.value, is(330L));
            Day03.Cell cell20 = cell19.next();
            assertThat(cell20.value, is(351L));
            Day03.Cell cell21 = cell20.next();
            assertThat(cell21.value, is(362L));
            Day03.Cell cell22 = cell21.next();
            assertThat(cell22.value, is(747L));
            Day03.Cell cell23 = cell22.next();
    ...
    public void solvePuzzle() {
        Day03.Cell currentCell = Day03.Cell.firstCell();
